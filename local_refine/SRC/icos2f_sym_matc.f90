subroutine icos2f_sym_matc(r,N)
    implicit none
    integer i1,N
    real pi,phi
    real r(3,3,N)
...
subroutine icos2f_sym_matasym(r,N)
    implicit none
    integer i1,N
    real pi,phi
    real r(3,3,N)
...
subroutine icos_matrix_i2(r,N)
    ...
    v=acos(cos(60.0*deg2rad)/sin(36.0*deg2rad))     !angle between 2f and 5f,31.717deg
    w=acos(cos(36.0*deg2rad)/sin(60.0*deg2rad))     !angle between 2f and 3f£¬20.905deg
...
subroutine icos_matrix_i5(r,N)
implicit none
    integer N,i1,j1
    real r(3,3,N),v,deg2rad,rot0(3,3),rad2deg
