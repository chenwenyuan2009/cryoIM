subroutine icos_equalort12(theta0,phi0,omega0,angle)
    implicit none
    integer i
    real theta0,phi0,omega0,theta,phi,omega,angle(3,12),maticos(3,3,12),mat(3,3),matoular(3,3)

    theta=theta0
    phi  =-phi0
    omega=180.0-omega0
    call icos2f_sym_matc12(maticos)
