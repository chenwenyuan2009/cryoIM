...
subroutine project2d
    use common_icosproc
    implicit none
    integer ix,iy,iz,i3,i2,itemplate,n1,n2,n3,n4,n5,n6,n7,n8,i,j
    real theta,phi,omega
    real rotMat(3,3), Xprime(3), X(3), xbit, ybit, zbit
    real,allocatable :: img3d(:), slice(:),a(:)
    ...
    read(11) mrc
    FFTsize=mrc%nx
    allocate(img3d(FFTsize**3),slice(FFTsize**2),a(FFTsize**2))
    img3d     =.0
    do i=1,FFTsize
      read(11) a
      do j=1,FFTsize**2
